...
<div class="page">
  ...
  <div class="status-banner" style="background:${getStatusBg(scan.status)};border:2px solid ${scan.status === 'pass' ? '#A7F3D0' : scan.status === 'fail' ? '#FECACA' : '#FDE68A'};">
    ...
    <div class="score-circle" style="color:${getStatusColor(scan.status)};">
      <div class="score-value">${scan.complianceConfidence ?? 0}%</div>
      <div class="score-label">Compliance Confidence</div>
    </div>
  </div>
  ...
  <div class="disclaimer">
    ...
    <div class="disclaimer-text">
      This report is generated by PRAMAN — an AI-assisted compliance screening tool operated independently,
      unaffiliated with any government body. Font size measurements are
  ...
  <!-- Footer -->
  <div class="footer">
    <div class="footer-text">PRAMAN · Smart India Hackathon — PS ID 26034 · AI-assisted compliance screening (unaffiliated with any government body)</div>
